...
const politicalAsylum: ServiceData = {
  ...
  howWeHelp: {
    content:
      '宇律师事务所在政治庇护领域拥有丰富的经验，特别擅长处理来自中国的庇护案件。我们深刻理解华人申请者所面临的独特挑战，并提供全中文的法律服务，确保沟通无障碍。',
    points: [
  ...
  testimonial: {
    quote:
      '宇律师帮助我成功获得了政治庇护。从最初的咨询到最终的面谈，她都非常耐心和专业。作为一名因政治原因受到迫害的人，能遇到一位既懂法律又了解中国国情的律师，我感到非常幸运。',
    name: '王先生',
    caseType: '政治庇护',
  },
  faq: [
...
const affirmativeAsylum: ServiceData = {
  ...
  testimonial: {
    quote:
      '我通过宇律师的帮助成功通过了主动庇护面谈。她帮我准备的个人陈述非常详尽，面谈前的模拟练习让我对整个过程有了充分的了解。面谈当天宇律师全程陪同，让我感到很安心。',
    name: '陈女士',
    caseType: '主动庇护',
  },
  faq: [
...
const defensiveAsylum: ServiceData = {
  ...
  seo: {
    ...
    description:
      '在洛杉矶移民法庭面临递解？宇律师提供专业的防御性庇护法律服务，帮助您在法庭上争取庇护保护。中文服务，免费咨询。',
    h1: '防御性庇护法律服务',
  },
  whatIs: {
    title: '什么是防御性庇护？',
  ...
  howWeHelp: {
    content:
      '在防御性庇护案件中，宇律师拥有丰富的移民法庭出庭经验。我们理解法庭程序的复杂性和面临递解的紧迫性，致力于为每一位客户提供最强有力的法律辩护。',
    points: [
      '紧急案件评估和制定辩护策略',
      '所有法庭听证的全程代理',
      '专业的证据准备和案件构建',
  ...
  testimonial: {
    quote:
      '当我面临递解的时候，宇律师挺身而出。她在法庭上的专业表现和有力辩护让法官批准了我的庇护申请。整个过程中她都用中文和我沟通，让我在这个艰难的时期感到有依靠。',
    name: '李先生',
    caseType: '防御性庇护',
  },
  faq: [
...
function makePartialService(
  ...
  return {
    ...
    howWeHelp: {
      content: `宇律师事务所在${title}方面拥有丰富经验。我们提供全中文服务，确保沟通无障碍。`,
      points: [
        '免费初次咨询和案件评估',
        '全程中文法律服务',
        '专业的文件准备和案件构建',
    ...
    testimonial: {
      quote: `宇律师在${title}方面非常专业，帮助我顺利解决了移民问题。整个过程中都用中文沟通，非常感谢！`,
      name: '客户',
      caseType: title,
    },
    faq,
...
const asylumDenialAppeal = makePartialService(
  ...
  '庇护申请被拒？宇律师提供专业的上诉和重新申请服务，包括BIA上诉、联邦法院审查和重新开案动议。',
  [
...
const deportationDefense = makePartialService(
  ...
  'additional',
  '洛杉矶递解抗辩律师 | 中文递解防御服务',
  '面临递解？宇律师提供专业的递解抗辩服务，探索庇护、暂缓递解、取消递解等所有救济途径。',
  [
