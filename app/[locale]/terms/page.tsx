        ...
        <div className="max-w-[800px] mx-auto px-6">
          <div className="prose prose-gray max-w-none text-gray-700 leading-[1.9] text-[15px] space-y-8">
            ...
            <div>
              ...
              <p>
                欢迎访问宇霞移民服务中心网站（以下简称"本网站"）。使用本网站即表示您同意遵守以下使用条款。如果您不同意这些条款，请勿使用本网站。
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p>
                本网站上的所有内容，包括但不限于文字、图片、图形、标识、按钮图标、音视频材料、数据编辑和软件，均为宇霞移民服务中心或其内容提供者的财产，受美国和国际版权法、商标法及其他知识产权法律的保护。
              </p>
              <p className="mt-3">
