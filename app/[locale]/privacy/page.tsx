...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: '隐私政策 | 宇霞移民服务中心',
    description:
      '宇霞移民服务中心隐私政策，说明我们如何收集、使用和保护您的个人信息。',
  };
}
        ...
        <div className="max-w-[800px] mx-auto px-6">
          <div className="prose prose-gray max-w-none text-gray-700 leading-[1.9] text-[15px] space-y-8">
            ...
            <div>
              ...
              <p>
                宇霞移民服务中心（以下简称"本所"或"我们"）尊重每位访客和客户的隐私。当您访问我们的网站、填写在线咨询表格、通过电话或微信联系我们、或使用我们的法律服务时，我们可能会收集以下类型的个人信息：
              </p>
            ...
            <div>
              ...
              <div className="mt-3 bg-gray-50 rounded-lg p-5 text-sm">
                <p className="font-semibold text-gray-900">宇霞移民服务中心</p>
