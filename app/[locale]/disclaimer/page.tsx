...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: '法律免责声明 | 宇霞移民服务中心',
    description:
      '宇霞移民服务中心法律免责声明，请在使用本网站和法律服务前仔细阅读。',
  };
}
        ...
        <div className="max-w-[800px] mx-auto px-6">
          ...
          <div className="prose prose-gray max-w-none text-gray-700 leading-[1.9] text-[15px] space-y-8">
            ...
            <div>
              ...
              <p>
                仅通过浏览本网站、发送电子邮件、填写在线咨询表格、拨打电话或通过微信等方式联系本所，并不会在您与宇霞移民服务中心之间建立律师-客户关系。律师-客户关系仅在您与本所签署正式的委托代理协议（Retainer Agreement）并完成相关程序后才正式建立。
              </p>
              <p className="mt-3">
            ...
            <div>
              ...
              <p>
                宇霞移民服务中心在美国加利福尼亚州注册，本服务中心获准在加利福尼亚州执业。联邦移民法案件不受州执业限制，本服务中心可以代理全美各州的联邦移民案件。但本网站不构成在任何司法管辖区内要求提供法律服务的邀请。在某些司法管辖区，本网站上的内容可能被视为律师广告，须受当地律师广告规则的约束。
              </p>
            </div>
