...
const faqCategories: FaqCategory[] = [
  {
    ...
    questions: [
      ...
      },
      {
        question: '庇护申请需要多少费用？',
        answer:
          '提交I-589庇护申请表本身无需向政府缴纳申请费。但聘请律师代理您的案件会产生律师费用。宇律师事务所提供免费初次咨询，我们会在了解您的情况后提供透明的费用报价。我们也提供灵活的分期付款方案，确保您能获得专业的法律帮助。',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        question: '我需要准备哪些材料？',
        answer:
          '关键材料包括：填写完整的I-589表格、详细的个人声明书（陈述您遭受迫害或恐惧迫害的经历）、身份证明文件（护照、身份证等）、支持性证据（国别报告、新闻报道、医疗记录、照片等）、以及证人证词或专家意见。宇律师事务所会帮助您系统地收集和整理所有必要的证据材料。',
      },
      {
    ...
    questions: [
      {
        ...
        answer:
          '充分准备包括：（1）熟悉您的I-589表格和个人声明的每一个细节；（2）与律师进行模拟面谈练习；（3）整理所有证据材料并按顺序排列；（4）了解面谈的基本流程和注意事项；（5）保证充足的休息。面谈时保持诚实、冷静，有条理地陈述您的经历。宇律师事务所会为您提供全面的面谈准备辅导。',
      },
      {
        question: '面谈时需要翻译吗？',
        answer:
          '如果您不能流利使用英语，您需要自行带一位合格的翻译陪同参加面谈。翻译必须年满18岁，流利掌握英语和您的母语，且不能是您的律师或代理人。USCIS不提供翻译服务。宇律师事务所可以协助您安排合格的中文翻译。',
      },
      {
