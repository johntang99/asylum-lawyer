...
const faqCategories: FaqCategory[] = [
  {
    ...
    questions: [
      ...
      {
        question: '庇护案件通常会经历哪些审理环节？',
        answer:
          '庇护案件通常会经历递交I-589、指纹与背景核查、面谈或听证等环节。不同个案的审理路径和节奏可能不同，但核心法律标准一致。律师会根据您的具体情况制定最合适的申请与应对策略。',
      },
      {
      ...
      },
      {
        question: '庇护申请需要多少费用？',
        answer:
          '提交I-589庇护申请表本身无需向政府缴纳申请费。但聘请律师代理您的案件会产生律师费用。宇霞移民服务中心提供免费初次咨询，我们会在了解您的情况后提供透明的费用报价。我们也提供灵活的分期付款方案，确保您能获得专业的法律帮助。',
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          '庇护案件的基本流程通常包括：（1）准备并提交I-589表格及支持材料；（2）收到USCIS收据通知；（3）采集指纹和背景调查；（4）参加面谈或听证；（5）收到审理结果。整个过程中，律师会全程协助您准备材料并应对各阶段要求。',
      },
      {
        question: '庇护案件通常需要多长时间？',
        answer:
          '处理时间因案件类型和地区而异。一般来说，面谈或听证安排可能在提交申请后数月到一年以上，复杂案件可能更久。近年来，USCIS实施了"后进先出"（LIFO）政策，较新的案件有时会更快得到审理。具体时间线需要根据您的个案情况评估。',
      },
      {
        question: '我需要准备哪些材料？',
        answer:
          '关键材料包括：填写完整的I-589表格、详细的个人声明书（陈述您遭受迫害或恐惧迫害的经历）、身份证明文件（护照、身份证等）、支持性证据（国别报告、新闻报道、医疗记录、照片等）、以及证人证词或专家意见。宇霞移民服务中心会帮助您系统地收集和整理所有必要的证据材料。',
      },
      {
    ...
    questions: [
      {
        ...
        answer:
          '充分准备包括：（1）熟悉您的I-589表格和个人声明的每一个细节；（2）与律师进行模拟面谈练习；（3）整理所有证据材料并按顺序排列；（4）了解面谈的基本流程和注意事项；（5）保证充足的休息。面谈时保持诚实、冷静，有条理地陈述您的经历。宇霞移民服务中心会为您提供全面的面谈准备辅导。',
      },
      {
        question: '面谈时需要翻译吗？',
        answer:
          '如果您不能流利使用英语，您需要自行带一位合格的翻译陪同参加面谈。翻译必须年满18岁，流利掌握英语和您的母语，且不能是您的律师或代理人。USCIS不提供翻译服务。宇霞移民服务中心可以协助您安排合格的中文翻译。',
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          '如果庇护申请被拒，通常仍有补救路径：例如在移民法庭继续主张保护、向移民上诉委员会（BIA）提起上诉（通常为30天期限），以及在符合法律条件时向联邦上诉法院申请司法审查。每一个阶段都有严格时间限制，务必及时咨询律师。',
      },
      {
      ...
      >
        <div className="max-w-[700px] mx-auto px-6 text-center">
          ...
          <p className="text-white/75 mb-8 leading-relaxed">
            每个庇护案件都有其独特之处，我们可以针对您的具体情况提供专业解答
          </p>
