...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: '客户评价 | 正道移民服务中心',
    description:
      '查看正道移民服务中心庇护移民案件客户的真实评价与反馈，了解我们如何帮助客户成功获得庇护身份。',
  };
}
...
const testimonials: Testimonial[] = [
  ...
  },
  {
    stars: 5,
    quote:
      '正道移民服务中心在处理I-589申请方面经验丰富。他们帮我收集和整理了所有必要的证据材料，个人声明写得非常详尽有力。我的案件在面谈后很快就获得了批准。价格也很合理，还提供分期付款。',
    name: '黄先生',
    caseType: 'I-589',
    year: '2024',
  },
  ...
  },
  {
    stars: 5,
    quote:
      '我是通过朋友推荐找到正道移民服务中心的。从第一次免费咨询就感受到了专业和真诚。律师详细分析了我的案情，指出了优势和需要加强的地方，并帮我制定了完整的申请策略。最终结果证明选择律师是正确的决定。',
    name: '孙先生',
    caseType: '政治庇护',
    year: '2024',
  },
  ...
  {
    stars: 5,
    quote: '防御性庇护成功！在法庭上律师的表现非常专业，法官对我们的证据材料印象深刻。',
    name: '郑女士',
    caseType: '防御性庇护',
    year: '2024',
  },
  ...
  },
  {
    stars: 5,
    quote:
      '正道移民服务中心的团队配合非常默契。律师负责法律策略，助理帮忙整理文件和跟进进度，前台小姐姐也很热情友好。每次去律所都感到很安心。我的庇护绿卡已经顺利拿到，感谢整个团队的付出。',
    name: '韩先生',
    caseType: '庇护绿卡',
    year: '2024',
  },
